...
# @itchat.msg_register([itchat.content.TEXT,itchat.content.PICTURE],isFriendChat=True) #跟跟好友对话
#
...
#         print(reply)
#         itchat.send('@img@%s' % 'F:/pythonwork/weixin_chat/wechat/1.png',toUserName='小y')
#         itchat.send_image('F:/pythonwork/weixin_chat/wechat/1.png', toUserName='小y')
#         # reply = reply + '\n<自动回复>'
